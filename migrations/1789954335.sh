...
#
# sweeps: enabled console-well.timer
# sweeps: /etc/systemd/user/console-well.service
# sweeps: /etc/systemd/user/console-well.timer
# sweeps: /usr/local/bin/console-fell

echo "standing down the startup check under its old name"

console-unenable console-well.timer
console-attic /etc/systemd/user/console-well.timer
console-attic /etc/systemd/user/console-well.service

echo "sweeping the crash reporter under its old name"

console-attic /usr/local/bin/console-fell
