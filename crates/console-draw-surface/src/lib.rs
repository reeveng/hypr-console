...
//! That crate is GPL-3.0-or-later because it is a derivative of somebody else's
...
//! which nobody owns, and the keyboard keeps its copy until it is the last
//! caller left and can be asked whether it wants to change licence.
//!
...
pub use scale::Scale;
pub use standing::{Anchor, Gone, Keyboard, Margin, Missing, Poke, Room, Surface, Under, Wanted};
