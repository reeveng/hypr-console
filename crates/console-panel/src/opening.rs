...
//!
//! `console_wait_times` is where the numbers go and what they mean. This is the
...
//!
//! `asked` is the same stopwatch started for a panel that was not exec'd. The
//! stand-in was, so it hands over what its own start cost and what the press
//! behind it was stamped with, and the marks read the way they always did --
//! minus the one for the toolkit coming up, whose absence is the point.
