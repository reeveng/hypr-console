...
use console_gamepad::go::{LegionGo, Passing};
use console_gamepad::profile::Profile;
use console_gamepad::router::every_profile;
use console_gamepad::script::{self, VERBS};
use console_gamepad::uinput::Uinput;
...
fn read(args: Vec<String>) -> Result<Option<Asked>, String> {
    let mut profile = console_gamepad::router::NAME.to_string();
...
fn interactive<S: console_gamepad::devices::Sink>(
