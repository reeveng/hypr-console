...
//! and nothing says how long it is meant to run. [`Alongside`](crate::Alongside)
//! and [`LetGo`](crate::LetGo) make a caller say which it meant about a child,
...
//! `Alongside` does something as well as saying something; a thread cannot, so
...
//! nobody will ever read, and a thread computing something for a caller that is
