...
//! mako read at startup -- its colors, its size, where it sat, how long a card
...
//! speaks any more, and the day someone finds it while wondering why a card is
//! the wrong color is a day spent on a file that has not been read since this
//! commit.
//!
...
pub const MIGRATION: Migration = Migration {
    moment: Moment(1789073080),
    says: "sweeping mako's configuration, which nothing reads now that the card is ours",
    steps: &[
        Step::Attic("/home/@user@/.config/mako/config"),
        Step::Attic("/home/@user@/.config/mako"),
    ],
};
