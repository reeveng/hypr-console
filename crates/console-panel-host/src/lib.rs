...
pub const PANELS: &[Panel] = &[
    ...
    Panel { who: console_viewer::WHO, card: console_viewer::card },
    Panel { who: console_download::WHO, card: console_download::card },
    Panel { who: console_notifications::WHO, card: console_notifications::card },
    Panel { who: console_button_layout::WHO, card: console_button_layout::card },
];
